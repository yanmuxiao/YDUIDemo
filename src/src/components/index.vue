<template>
    <yd-layout>
        ...
        <yd-grids-group rows="4">
            <yd-grids-item v-for="item in list" :link="item.link" :key="item.name">
                <!-- <i slot="icon" :class="item.icon"></i> -->
                <yd-icon slot="icon" :name="item.icon" color="#FF685D" size=".6rem"></yd-icon>
...
<script type="text/babel">
    export default {
        data() {
            return {
                list: [
                    {icon: 'home', name: 'Button', link: '/button'},
                    {icon: 'home-outline', name: 'Dialog', link: '/dialog'},
                    {icon: 'shopcart', name: 'Cell', link: '/cell'},
                    {icon: 'shopcart-outline', name: 'Icons', link: '/icons'},
                    {icon: 'ucenter', name: 'Grids', link: '/grids'},
                    {icon: 'ucenter-outline', name: 'List', link: '/list'},
                    {icon: 'star', name: 'Badge', link: '/badge'},
