<template>
	...
	<div>
        ...
        <div class="searchFixed">
            <yd-search :style="'background-color: rgba(50,65,87,' + searchFixedOpacity + ')'" :result="result" fullpage v-model="searchValue" :itemClick="clickHandler" :on-submit="submitHandler" :on-cancel="cancelHandler"></yd-search>
        </div>
